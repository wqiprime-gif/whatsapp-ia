...
/** Ícone squircle preto com o fantasma branco — PWA e notificações.
 *  Aqui vale a silhueta vetorial, e não o render metalico: em 48px o degrade
 *  vira sujeira e o fundo da foto deixa emenda visivel dentro do squircle. */
