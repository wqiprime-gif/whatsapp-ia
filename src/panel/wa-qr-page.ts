      ...
      async function loadQr() {
        ...
        try {
          ...
          if (data.qr) {
            ...
            wrap.innerHTML = '<div style="width:64px;height:64px;margin:0 auto;border-radius:50%;background:rgba(255, 255, 255,0.15);border:2px solid #d4d4d4;display:grid;place-items:center"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#d4d4d4" stroke-width="2.5"><path d="M20 6L9 17l-5-5"/></svg></div><p class="form-hint" style="margin-top:12px;color:#d4d4d4">Instância conectada ao WhatsApp.</p>';
