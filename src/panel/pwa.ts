...
export const SERVICE_WORKER_JS = `const SW_VERSION = "x1black-v1.30.0";
// PNG WhatsApp azul (telefone) — mesmo papel do favicon.svg do instablack.
const NOTIFY_ICON = "/brand/pwa-192.png?v=1.30.0";
...
<link rel="icon" href="/brand/pwa-192.png?v=1.30.0" type="image/png" sizes="192x192" />
<link rel="apple-touch-icon" href="/brand/pwa-192.png?v=1.30.0" />
