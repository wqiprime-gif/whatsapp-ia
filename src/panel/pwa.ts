...
export const SERVICE_WORKER_JS = `const SW_VERSION = "x1black-v1.31.1";
const NOTIFY_ICON = "/brand/pwa-192.png?v=1.31.1";
...
<link rel="icon" href="/brand/favicon.svg?v=1.31.1" type="image/svg+xml" />
<link rel="icon" href="/brand/pwa-192.png?v=1.31.1" type="image/png" sizes="192x192" />
<link rel="apple-touch-icon" href="/brand/pwa-192.png?v=1.31.1" />
